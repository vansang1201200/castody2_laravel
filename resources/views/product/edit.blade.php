            ...
            <div class="col-12">
                <form method="post" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="">
                            @foreach($categories as $cate)
                                <option value="{{$cate->id}}" @if($cate->id == $product->category_id ) selected @endif>{{$cate->name}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="" class="ckeditor" name="describe_product"
                                  value="">{!! $product->describe_product !!}</textarea>
